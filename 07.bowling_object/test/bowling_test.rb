...
class BowlingTest < Minitest::Test
  ...
  def test_bowling
    assert_equal 139, @game1.calculate_point
    assert_equal 164, @game2.calculate_point
    assert_equal 107, @game3.calculate_point
    assert_equal 134, @game4.calculate_point
    assert_equal 300, @game5.calculate_point
  end
end
